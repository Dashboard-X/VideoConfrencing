...
namespace Silverlight2Chat.Web
{
    ...
    partial void OnSexChanged();
		...
		[Association(Name="User_PrivateMessage", Storage="_PrivateMessages", ThisKey="UserID", OtherKey="UserID")]
		...
		[Association(Name="User_PrivateMessage1", Storage="_PrivateMessages1", ThisKey="UserID", OtherKey="ToUserID")]
	...
	public partial class PrivateMessage : INotifyPropertyChanging, INotifyPropertyChanged
	{
		...
		private System.DateTime _TimeUserSentInvitation;
    ...
    partial void OnTimeUserSentInvitationChanging(System.DateTime value);
    partial void OnTimeUserSentInvitationChanged();
    #endregion
		...
		[Column(Storage="_TimeUserSentInvitation", DbType="DateTime NOT NULL")]
		public System.DateTime TimeUserSentInvitation
		{
			get
			{
				return this._TimeUserSentInvitation;
			}
			set
			{
				if ((this._TimeUserSentInvitation != value))
				{
					this.OnTimeUserSentInvitationChanging(value);
					this.SendPropertyChanging();
					this._TimeUserSentInvitation = value;
					this.SendPropertyChanged("TimeUserSentInvitation");
					this.OnTimeUserSentInvitationChanged();
				}
			}
		}
		
		[Association(Name="User_PrivateMessage", Storage="_User", ThisKey="UserID", OtherKey="UserID", IsForeignKey=true)]
		public User User
		{
			get
			{
		...
		[Association(Name="User_PrivateMessage1", Storage="_User1", ThisKey="ToUserID", OtherKey="UserID", IsForeignKey=true)]
		public User User1
		{
			get
			{
