...
{
	/// <summary>LSP Quantisation and Unquantisation (narrowband)</summary>
	...
	public class NbLspQuant : org.xiph.speex.LspQuant
	{
		/// <summary>Line Spectral Pair Quantification (narrowband).</summary>
		/// <remarks>Line Spectral Pair Quantification (narrowband).</remarks>
			 ...
			 bits)
		{
			...
			id = lsp_weight_quant(qlsp, 0, quant_weight, 0, cdbk_nb_low2, NB_CDBK_SIZE_LOW2, 
				5);
			bits.pack(id, 6);
			...
			id = lsp_weight_quant(qlsp, 5, quant_weight, 5, cdbk_nb_high2, NB_CDBK_SIZE_HIGH2
				, 5);
			bits.pack(id, 6);
			for (i = 0; i < order; i++)
			{
		...
		/// <summary>Line Spectral Pair Unquantification (narrowband).</summary>
		/// <remarks>Line Spectral Pair Unquantification (narrowband).</remarks>
		/// <param name="lsp">- Line Spectral Pairs table.</param>
		/// <param name="order"></param>
		/// <param name="bits">- Speex bits buffer.</param>
