...
// SocketCoderDesktopServer Class is a part of SocketCoder Classes Project (C) SocketCoder.Com
...
{
    public class SocketCoderDesktopServer
    {
        ...
        internal class SocketCoderClient
        {
            ...
            public void SetupRecieveCallback()
            {
                try
                {
                    ...
                    AsyncCallback recieveData = new AsyncCallback(SocketCoderDesktopServer.OnRecievedData);
