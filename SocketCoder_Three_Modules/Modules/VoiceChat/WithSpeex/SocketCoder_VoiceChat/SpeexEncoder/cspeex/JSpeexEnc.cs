...
namespace cspeex
{
    ...
    public class JSpeexEnc
    {
        ...
        // Updated To Work On The Voice Chat (SocketCoder.Com) --|
        org.xiph.speex.SpeexEncoder Speex_Encoder = new org.xiph.speex.SpeexEncoder();
        ...
        public void InitialSettings()
        {
            ...
            mode = 0;
            version();
            Speex_Encoder.init(mode, quality, sampleRate, channels);
            Speex_Encoder.getEncoder().setComplexity(complexity);
            PacketSize = 2 * channels * Speex_Encoder.getFrameSize();
        }
